...
if(FALSE){
  ...
  cec <- rast("/home/frousseu/Downloads/can_land_cover_2020_30m_tif/CAN_NALCMS_landcover_2020_30m/data/CAN_NALCMS_landcover_2020_30m.tif")
  ...
  writeRaster(p, "cec300.tif", overwrite = TRUE)
...
fsl <- rast("/home/frousseu/Downloads/can_land_cover_2020_30m_tif/CAN_NALCMS_landcover_2020_30m/data/fsl.tif")
fsl <- aggregate(fsl, 2)
...
wc <- worldclim_country("CAN", path = getwd(), var = "bio")
...
el <- elevation_30s("CAN", getwd(), mask=FALSE)
